  ...
  header.innerHTML = `
    <div class="island-nav">
      ...
      <nav class="island-links">
       ...
       <a href="order-status.html" class="nav-item ${currentPage === 'order-status.html' ? 'active' : ''}">
...
function initDualFABs() {
  ...
  fabContainer.innerHTML = `
    <a href="https://whatsapp.com/channel/0029VbD19w4HAdNXDoXZFS2E" target="_blank" class="fab wa-fab" title="WhatsApp Support">
